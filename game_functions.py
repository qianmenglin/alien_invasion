...
def check_keydown_events(event, ai_settings, screen, ship, bullets):
    ...
    elif event.key == pygame.K_LEFT and ship.rect.left >= ship.screen_rect.left:
...
def update_aliens(ai_settings, stats, screen, aliens, ship, bullets, sb):
    ...
    if pygame.sprite.spritecollideany(ship, aliens):
        ship_hit(ai_settings, stats, screen, aliens, ship,  bullets, sb)

    check_aliens_bottom(ai_settings, stats, screen, ship, aliens, bullets, sb)


def ship_hit(ai_settings, stats, screen, aliens, ship, bullets, sb):
